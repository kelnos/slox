...
object Stmt {
  ...
  case class Class(name: Token, superclass: Option[Expr], staticMethods: Seq[Stmt.Function], methods: Seq[Stmt.Function], getters: Seq[Stmt.Function]) extends Stmt { val line: Int = name.line }
  ...
  case class TryCatch(keyword: Token, tryBranch: Stmt, exceptionIdentifier: Token, catchBranch: Stmt, finallyBranch: Option[Stmt]) extends Stmt { val line: Int = keyword.line }
